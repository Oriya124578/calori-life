...
const CREAM = {
  ...
  borderLight: 'var(--cream-warm)',
  handle: 'var(--cream-muted)',
  tabBg: 'var(--color-secondary)',
  green: '#059669',
  blue: '#2563EB',
  amber: '#D97706',
};
...
const CatChip = ({ active, onClick, accentColor, children }) => (
  <button
    ...
    style={{
      ...
      fontFamily: active ? serif : 'inherit',
      fontStyle: active ? 'italic' : 'normal',
      background: active ? accentColor : 'var(--color-card)',
...
const DueChip = ({ active, onClick, children }) => (
  <button
    ...
    style={{
      ...
      fontFamily: active ? serif : 'inherit',
      fontStyle: active ? 'italic' : 'normal',
      background: active ? CREAM.green : 'var(--color-card)',
